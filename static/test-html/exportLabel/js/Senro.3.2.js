...
Senro.prototype={
    ...
    getCurrentTime:function (callback){
         ...
         * @实例：  /test-html/3.2/core/getCurrentTime.html；
         * @需要：  无；
         * @备注：  暂无 todo；
         */
    ...
    isDateOverdue: function (beginDate, endDate) {
         ...
         * @返回：  布尔值；
         * @实例：  /test-html/3.2/core/isDateOverdue.html；
         * @需要：  无；
         * @备注：  暂无 todo；
         */
    ...
    isTimeOverdue: function (beginTime,endTime,callback) {
         ...
         * @返回：  布尔值；
         * @实例：  /test-html/3.2/core/isTimeOverdue.html；
         * @需要：  无；
         * @备注：  暂无 todo；
         */
        var lastTime=normalized(beginTime)-normalized(endTime);
